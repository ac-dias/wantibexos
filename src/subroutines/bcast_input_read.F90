...
call MPI_BCAST(penn_q0,1,MPI_REAL,root,MPI_COMM_WORLD,ierr)
call MPI_BCAST(qtf2d,1,MPI_REAL,root,MPI_COMM_WORLD,ierr)
call MPI_BCAST(alpha_2d,1,MPI_REAL,root,MPI_COMM_WORLD,ierr)
