...
call MPI_BCAST(coultype,7,MPI_CHARACTER,root,MPI_COMM_WORLD,ierr)
...
call MPI_BCAST(bse_eph_file,160,MPI_CHARACTER,root,MPI_COMM_WORLD,ierr)
call MPI_BCAST(bse_eph_eta,1,MPI_REAL,root,MPI_COMM_WORLD,ierr)
call MPI_BCAST(bse_eph_temp,1,MPI_REAL,root,MPI_COMM_WORLD,ierr)
...
call MPI_BCAST(bsekpathcheckpointfile,70,MPI_CHARACTER,root,MPI_COMM_WORLD,ierr)
...
call MPI_BCAST(bsekpathcheckpoint,1,MPI_LOGICAL,root,MPI_COMM_WORLD,ierr)
