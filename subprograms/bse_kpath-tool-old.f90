...
subroutine bsebnds(nthreads,outputfolder,calcparms,ngrid,nc,nv,edos0,edosf,numdos, &
	...
	! $omp parallel do
		do i2=1,ngkpt
			...
			call eigsys2(nthreads,scs,exc,nocpq(i2),ffactor,qpt(i2,1),qpt(i2,2),qpt(i2,3),w90basis,nvec,&
